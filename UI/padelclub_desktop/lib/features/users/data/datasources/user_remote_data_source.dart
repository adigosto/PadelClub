...
abstract class UserRemoteDataSource {
  Future<List<UserModel>> getUsers({Map<String, dynamic>? filter});
}
...
class UserRemoteDataSourceImpl implements UserRemoteDataSource {
  ...
  UserRemoteDataSourceImpl({required this.client, this.baseUrl = const String.fromEnvironment('baseUrl', defaultValue: 'http://localhost:5001/api')});

  @override
  Future<List<UserModel>> getUsers({Map<String, dynamic>? filter}) async {
