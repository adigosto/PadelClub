        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrizeInfo = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Score = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assets_ProductId_DisplayOrder",
                table: "Assets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Memberships_UserId_IsActive",
                table: "Memberships",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CourtId_StartTime_EndTime",
                table: "Reservations",
